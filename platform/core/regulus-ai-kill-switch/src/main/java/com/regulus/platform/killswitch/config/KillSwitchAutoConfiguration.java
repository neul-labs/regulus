package com.regulus.platform.killswitch.config;

import com.regulus.platform.killswitch.interceptor.InMemoryKillSwitchStateProvider;
import com.regulus.platform.killswitch.interceptor.KillSwitchInterceptor;
    ...
    static class DefaultKillSwitchContextExtractor
        ...
        public KillSwitchInterceptor.KillSwitchContext extract(ProceedingJoinPoint joinPoint) {
            ...
            var agentAnnotation = targetClass.getAnnotation(
                com.regulus.platform.killswitch.interceptor.AiAgent.class);
            ...
            if (joinPoint.getSignature() instanceof MethodSignature methodSig) {
                var opAnnotation = methodSig.getMethod().getAnnotation(
                    com.regulus.platform.killswitch.interceptor.AiOperation.class);
