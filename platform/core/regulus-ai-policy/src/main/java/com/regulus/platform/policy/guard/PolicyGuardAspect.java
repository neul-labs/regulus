...
import com.regulus.platform.policy.annotation.RequirePolicy;
...
public class PolicyGuardAspect {
    ...
    @Around("@annotation(com.regulus.platform.policy.annotation.RequirePolicy)")
    ...
    @Around("@within(com.regulus.platform.policy.annotation.RequirePolicy)")
